...
from veriflow._canonical import CanonicalizationError
from veriflow.engine import ProposedClaim, assure, verify_receipt
from veriflow.engine.contracts import canonical_hash, legacy_canonical_hash
from veriflow.lanes.financial.models import stable_hash as financial_hash
...
class CanonicalHashTests(unittest.TestCase):
    ...
    def test_v1_receipt_remains_verifiable(self):
        ...
        content = {
            "engine_version": "veriflow.engine.v1",
