"""Glass Ionomer unified engine: Reasoner (fail-open) -> Verifier (non-LLM core) -> Enforcer.

The best-of-all-worlds synthesis of DCER+PXB, AmrThink, and the Glass Ionomer Lane-A core,
behind one honest pipeline. See contracts.py for the load-bearing invariants.
"""
from __future__ import annotations

from glass_ionomer.verify.trust import DerivationProof, issue_trusted_derivation_proof
